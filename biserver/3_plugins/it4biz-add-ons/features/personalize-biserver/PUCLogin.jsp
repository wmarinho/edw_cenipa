...
%>
    <div id="login-form-container" class="lang_<%=cleanedLang%>">
      <div id="animate-wrapper">
        <h1>{MAIN_TITLE}
			<p><small>{SECONDARY_TITLE}</small></p>
		</h1>
  ...
  <div id="login-footer-wrapper">
	...
	<p>Copyright &copy; IT4biz - Information Technology For Business.</p>
    <p><a target="no_blank" href="http://www.it4biz.com.br">Powered by IT4biz</a></p>
  </div>
</div>
